            ...
            <div className="w-full px-5">
                <div className="max-w-7xl mx-auto mt-10">
                    ...
                    <div className="pt-5 text-lg">
                        ...
                        <button className="md:w-1/3 px-3 py-3 border rounded-3xl mr-5" onClick={()=>{setGender("m")}}>남자🧑🏻</button>
                        <button className="md:w-1/3 px-3 py-3 border rounded-3xl" onClick={()=>{setGender("f")}}>여자👧🏻</button>
                    </div>                   
                    <div className="pt-5 text-lg">
                        <p className="pb-5">🎉생년월일을 입력해주세요</p>
                        <input className="w-full md:w-1/2 lg:w-1/3 border py-2 px-5 rounded-3xl" type="text" onChange={birthChange} placeholder="생년월일(8자리)" value={birthDate} />
                    </div>
                    <div className="pt-5 text-lg">
                        <p className="pb-5">📆양력,음력을 골라주세요</p>
                        <select className="w-full md:w-1/2 lg:w-1/3 border py-2 px-5 rounded-3xl" value={month} onChange={(e)=>setMonth(e.target.value)}>
                    ...
                    <div className="pt-5 text-lg">
                        ...
                        <select className="w-full md:w-1/2 lg:w-1/3 border py-2 px-5 rounded-3xl" value={time} onChange={(e)=>setTime(e.target.value)}>
